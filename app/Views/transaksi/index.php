                                        ...
                                        <div class="contact-form">
                                            <div class="leave-comment">
                                                ...
                                                <form action="komentar/create" class="comment-form" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <select name="id_tansaksi_detail_barang" class="sorting">
                                                                <?php foreach ($transaksiDetails as $index => $transaksiDetail) : ?>
                                                                    <option value="<?= $transaksiDetail->id ?>_<?= $transaksiDetail->id_barang ?>">Transaction <?= $transaksiDetail->created_date ?> (<?= $transaksiDetail->nama ?>)</option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-12">
